...
Funktionalität: Sperrzeiten für Studienordnungen
  ...
  Grundlage:
    Angenommen unser Stundenplan sieht so aus:
      ...
      | Mittwoch | 10:00 |        |
      | Freitag  | 10:00 |        |
    #Zufällig übereinstimmende Primärschlüssel von Komponenten und Kursen vermeiden
    Angenommen es gibt 10 Kurse ohne Komponenten in der Datenbank 
  ...
  Szenario: Fremde Kurse sind nicht betroffen
    ...
    Und der Kurs "Computer Vision" gehört zum Studiengang "Master Informatik"
    Angenommen der Studiengang "Bachelor Informatik" hat eine Sperrzeit am Mittwoch um 10:00 Uhr
    Und der Studiengang "Bachelor Informatik" hat eine Sperrzeit am Freitag um 10:00 Uhr
