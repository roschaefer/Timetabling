...
Unavailability.create(:id =>  0, :teacher => teacher_schaub, :weekday_id => 0, :timeframe_id => 0)
Unavailability.create(:id =>  1, :teacher => teacher_schaub, :weekday_id => 0, :timeframe_id => 1)
Unavailability.create(:id =>  2, :teacher => teacher_schaub, :weekday_id => 0, :timeframe_id => 2)
Unavailability.create(:id =>  3, :teacher => teacher_schaub, :weekday_id => 0, :timeframe_id => 3)
Unavailability.create(:id =>  4, :teacher => teacher_schaub, :weekday_id => 0, :timeframe_id => 4)
Unavailability.create(:id =>  5, :teacher => teacher_schaub, :weekday_id => 0, :timeframe_id => 5)
Unavailability.create(:id =>  6, :teacher => teacher_schaub, :weekday_id => 0, :timeframe_id => 6)
Unavailability.create(:id =>  7, :teacher => teacher_schaub, :weekday_id => 1, :timeframe_id => 0)
Unavailability.create(:id =>  8, :teacher => teacher_schaub, :weekday_id => 1, :timeframe_id => 1)
Unavailability.create(:id =>  9, :teacher => teacher_schaub, :weekday_id => 1, :timeframe_id => 2)
Unavailability.create(:id => 10, :teacher => teacher_schaub, :weekday_id => 1, :timeframe_id => 3)
Unavailability.create(:id => 11, :teacher => teacher_schaub, :weekday_id => 1, :timeframe_id => 4)
Unavailability.create(:id => 12, :teacher => teacher_schaub, :weekday_id => 1, :timeframe_id => 5)
Unavailability.create(:id => 13, :teacher => teacher_schaub, :weekday_id => 1, :timeframe_id => 6)
Unavailability.create(:id => 14, :teacher => teacher_schaub, :weekday_id => 2, :timeframe_id => 0)
Unavailability.create(:id => 15, :teacher => teacher_schaub, :weekday_id => 2, :timeframe_id => 1)
Unavailability.create(:id => 16, :teacher => teacher_schaub, :weekday_id => 2, :timeframe_id => 2)
Unavailability.create(:id => 17, :teacher => teacher_schaub, :weekday_id => 2, :timeframe_id => 3)
Unavailability.create(:id => 18, :teacher => teacher_schaub, :weekday_id => 2, :timeframe_id => 4)
Unavailability.create(:id => 19, :teacher => teacher_schaub, :weekday_id => 2, :timeframe_id => 5)
Unavailability.create(:id => 20, :teacher => teacher_schaub, :weekday_id => 2, :timeframe_id => 6)
