...
courses = []
courses[0]  = Course.create(:name => "Informatik für Naturwissenschaftler I"                           , :teacher => voigt       , :participants => 90 )
courses[1]  = Course.create(:name => "Grundlagen der Informationsverarbeitung"                         , :teacher => lucke       , :participants => 10 )
courses[2]  = Course.create(:name => "Grundlagen der Programmierung"                                   , :teacher => schwill     , :participants => 10 )
courses[3]  = Course.create(:name => "Mathematik für Informatiker I"                                   , :teacher => reich       , :participants => 40 )
courses[4]  = Course.create(:name => "Theoretische Informatik I"                                       , :teacher => kreitz      , :participants => 200)
courses[5]  = Course.create(:name => "Argumentation Systems Engineering"                               , :teacher => gordon      , :participants => 10 )
courses[6]  = Course.create(:name => "Automotiv, Fahrassistenz und Selbstfahrer"                       , :teacher => kalkbrenner , :participants => 10 )
courses[7]  = Course.create(:name => "ClusterComputing Fachseminar"                                    , :teacher => schnor      , :participants => 12 )
...
Course::Component.create(:course => courses[0] , :type => "Vorlesung" , :teacher => voigt       , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[0] , :type => "Übung"     , :teacher => lamprecht   , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[1] , :type => "Vorlesung" , :teacher => lucke       , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[1] , :type => "Übung"     , :teacher => vogel       , :dates => 2, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[2] , :type => "Vorlesung" , :teacher => schwill     , :dates => 2, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[2] , :type => "Übung"     , :teacher => kiertscher  , :dates => 6, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[3] , :type => "Vorlesung" , :teacher => reich       , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[3] , :type => "Übung"     , :teacher => fiedler     , :dates => 2, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[4] , :type => "Vorlesung" , :teacher => kreitz      , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[4] , :type => "Übung"     , :teacher => kreitz      , :dates => 4, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[5] , :type => "Vorlesung" , :teacher => gordon      , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[6] , :type => "Seminar"   , :teacher => kalkbrenner , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[7] , :type => "Seminar"   , :teacher => schnor      , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[8] , :type => "Seminar"   , :teacher => scheffer    , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[9] , :type => "Vorlesung" , :teacher => schnor      , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[9] , :type => "Übung"     , :teacher => schnor      , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[10], :type => "Vorlesung" , :teacher => blanchard   , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[10], :type => "Übung"     , :teacher => blanchard   , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[11], :type => "Vorlesung" , :teacher => behr        , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[12], :type => "Vorlesung" , :teacher => lucke       , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[12], :type => "Übung"     , :teacher => zinke       , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
Course::Component.create(:course => courses[13], :type => "Projekt"   , :teacher => koehlmann   , :dates => 1, :minimum_working_days => 1, :double_lecture => false)
