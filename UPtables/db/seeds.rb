...
Course::Component.create!(:course => courses[0] , :type => "Vorlesung" , :teacher => voigt       , :dates => 1, :double_lecture => false, :participants => 100)
Course::Component.create!(:course => courses[0] , :type => "Übung"     , :teacher => lamprecht   , :dates => 1, :double_lecture => false, :participants => 25)
Course::Component.create!(:course => courses[1] , :type => "Vorlesung" , :teacher => lucke       , :dates => 1, :double_lecture => false, :participants => 100)
Course::Component.create!(:course => courses[1] , :type => "Übung"     , :teacher => vogel       , :dates => 2, :double_lecture => false, :participants => 12)
Course::Component.create!(:course => courses[2] , :type => "Vorlesung" , :teacher => schwill     , :dates => 2, :double_lecture => false, :participants => 100)
Course::Component.create!(:course => courses[2] , :type => "Übung"     , :teacher => kiertscher  , :dates => 6, :double_lecture => false, :participants => 10)
Course::Component.create!(:course => courses[3] , :type => "Vorlesung" , :teacher => reich       , :dates => 1, :double_lecture => false, :participants => 200)
Course::Component.create!(:course => courses[3] , :type => "Übung"     , :teacher => fiedler     , :dates => 2, :double_lecture => false, :participants => 10)
Course::Component.create!(:course => courses[4] , :type => "Vorlesung" , :teacher => kreitz      , :dates => 1, :double_lecture => false, :participants => 200)
Course::Component.create!(:course => courses[4] , :type => "Übung"     , :teacher => kreitz      , :dates => 4, :double_lecture => false, :participants => 10)
Course::Component.create!(:course => courses[5] , :type => "Vorlesung" , :teacher => gordon      , :dates => 1, :double_lecture => false, :participants => 40)
...
Course::Component.create!(:course => courses[9] , :type => "Vorlesung" , :teacher => schnor      , :dates => 1, :double_lecture => false, :participants => 30)
Course::Component.create!(:course => courses[9] , :type => "Übung"     , :teacher => schnor      , :dates => 1, :double_lecture => false, :participants => 30)
Course::Component.create!(:course => courses[10], :type => "Vorlesung" , :teacher => blanchard   , :dates => 1, :double_lecture => false, :participants => 30)
Course::Component.create!(:course => courses[10], :type => "Übung"     , :teacher => blanchard   , :dates => 1, :double_lecture => false, :participants => 30)
Course::Component.create!(:course => courses[11], :type => "Vorlesung" , :teacher => behr        , :dates => 1, :double_lecture => false, :participants => 20)
Course::Component.create!(:course => courses[12], :type => "Vorlesung" , :teacher => lucke       , :dates => 1, :double_lecture => false, :participants => 20)
Course::Component.create!(:course => courses[12], :type => "Übung"     , :teacher => zinke       , :dates => 1, :double_lecture => false, :participants => 10)
Course::Component.create!(:course => courses[13], :type => "Projekt"   , :teacher => koehlmann   , :dates => 1, :double_lecture => false, :participants => 10)
