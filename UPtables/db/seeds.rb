...
Course::Component.create!(:course => courses[0] , :type => :Exercise     , :teacher => lamprecht   , :dates => 1, :double_lecture => false, :participants => 25)
Course::Component.create!(:course => courses[1] , :type => :Lecture      , :teacher => lucke       , :dates => 1, :double_lecture => false, :participants => 100)
Course::Component.create!(:course => courses[1] , :type => :Exercise     , :teacher => vogel       , :dates => 2, :double_lecture => false, :participants => 12)
Course::Component.create!(:course => courses[2] , :type => :Lecture      , :teacher => schwill     , :dates => 2, :double_lecture => false, :participants => 100)
Course::Component.create!(:course => courses[2] , :type => :Exercise     , :teacher => kiertscher  , :dates => 6, :double_lecture => false, :participants => 10)
Course::Component.create!(:course => courses[3] , :type => :Lecture      , :teacher => reich       , :dates => 1, :double_lecture => false, :participants => 200)
Course::Component.create!(:course => courses[3] , :type => :Exercise     , :teacher => fiedler     , :dates => 2, :double_lecture => false, :participants => 10)
Course::Component.create!(:course => courses[4] , :type => :Lecture      , :teacher => kreitz      , :dates => 1, :double_lecture => false, :participants => 200)
Course::Component.create!(:course => courses[4] , :type => :Exercise     , :teacher => kreitz      , :dates => 4, :double_lecture => false, :participants => 10)
...
Course::Component.create!(:course => courses[9] , :type => :Exercise     , :teacher => schnor      , :dates => 1, :double_lecture => false, :participants => 30)
Course::Component.create!(:course => courses[10], :type => :Lecture      , :teacher => blanchard   , :dates => 1, :double_lecture => false, :participants => 30)
Course::Component.create!(:course => courses[10], :type => :Exercise     , :teacher => blanchard   , :dates => 1, :double_lecture => false, :participants => 30)
...
Course::Component.create!(:course => courses[12], :type => :Exercise     , :teacher => zinke       , :dates => 1, :double_lecture => false, :participants => 10)
